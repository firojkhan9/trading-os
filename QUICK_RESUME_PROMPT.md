...
LAST COMPLETED : Milestone 31 — Explainable Autonomous Decision Engine
CURRENT REQUIRED FIXES  :1.I have updated my watchlist with 1001 stock, now it's taking too much time to scan, is there a way to increase speed and efficiency?, 2. There is difference in composite score in the scanner and in stock score page. I ran scanner→ selected one stock→ ran stock score for that stock→ composite scores are different. i have uploaded the latest files. 
NEXT MILESTONE : Milestone 33 — 
